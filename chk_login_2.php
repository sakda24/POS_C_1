...
session_start();
        ...
        //รับค่า user & mem_password       
                  $mem_username = mysqli_real_escape_string($condb_c,$_POST['mem_username']);
                  $mem_password = mysqli_real_escape_string($condb_c,sha1($_POST['mem_password']));
